...
static void tc358x67_dsi_dpi_pre_enable(struct drm_bridge *bridge)
{
	...
	tc358x67_dsi_dpi_i2c_write(ctx->client, PPI_TX_RX_TA, 0x00060008);
	tc358x67_dsi_dpi_i2c_write(ctx->client, PPI_LPTXTIMECNT, 0x0000005);
	tc358x67_dsi_dpi_i2c_write(ctx->client, PPI_D0S_CLRSIPOCOUNT, 0x6);
	tc358x67_dsi_dpi_i2c_write(ctx->client, PPI_D1S_CLRSIPOCOUNT, 0x6);
	tc358x67_dsi_dpi_i2c_write(ctx->client, PPI_D2S_CLRSIPOCOUNT, 0x6);
	tc358x67_dsi_dpi_i2c_write(ctx->client, PPI_D3S_CLRSIPOCOUNT, 0x6);

	tc358x67_dsi_dpi_i2c_write(ctx->client, PPI_LANEENABLE, 0x7);
	tc358x67_dsi_dpi_i2c_write(ctx->client, DSI_LANEENABLE, 0x7);
...
static void tc358x67_dsi_dpi_post_disable(struct drm_bridge *bridge)
{
	struct tc358x67_dsi_dpi *ctx = bridge_to_tc358x67_dsi_dpi(bridge);
								   ...
								   enum drm_bridge_attach_flags flags)
{
	...
	dsi->mode_flags = MIPI_DSI_MODE_VIDEO | MIPI_DSI_MODE_VIDEO_SYNC_PULSE |
					  MIPI_DSI_MODE_VSYNC_FLUSH | MIPI_DSI_MODE_VIDEO_HFP |
...
static const struct drm_bridge_funcs tc358x67_dsi_dpi_bridge_funcs = {
	...
	.post_disable = tc358x67_dsi_dpi_post_disable,
