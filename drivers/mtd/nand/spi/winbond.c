...
static int w25nxxkv_ooblayout_ecc(struct mtd_info *mtd, int section,
				  struct mtd_oob_region *region)
{
...
static int w25nxxkv_ooblayout_free(struct mtd_info *mtd, int section,
				   struct mtd_oob_region *region)
{
	if (section > 3)
		return -ERANGE;
...
static const struct mtd_ooblayout_ops w25nxxkv_ooblayout = {
	.ecc = w25nxxkv_ooblayout_ecc,
	.free = w25nxxkv_ooblayout_free,
};
...
static const struct spinand_info winbond_spinand_table[] = {
	...
	SPINAND_INFO("W25N02KV",
		     ...
		     SPINAND_INFO_OP_VARIANTS(&read_cache_variants,
					      ...
					      &update_cache_variants),
		     0,
		     SPINAND_ECCINFO(&w25nxxkv_ooblayout, NULL)),
};
