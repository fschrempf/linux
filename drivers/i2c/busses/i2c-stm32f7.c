...
static void stm32f7_i2c_setup_wakeup(struct stm32f7_i2c_dev *i2c_dev)
{
	int ret;
...
static int stm32f7_i2c_probe(struct platform_device *pdev)
{
	...
	if (of_get_property(np, "wakeup-source", NULL)) {
		...
		if (i2c_dev->irq_wakeup > 0 &&
		    i2c_dev->irq_wakeup != i2c_dev->irq_event &&
		    i2c_dev->irq_wakeup != irq_error) {
			stm32f7_i2c_setup_wakeup(i2c_dev);
		}
	}
...
static int stm32f7_i2c_suspend(struct device *dev)
{
	...
	if (device_may_wakeup(i2c_dev->dev))
