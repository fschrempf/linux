...
#define IPVR_MINREV_SHIFT		0
#define IPVR_MINREV_MASK		GENMASK(3, 0)
#define IPVR_MAJREV_SHIFT		4
#define IPVR_MAJREV_MASK		GENMASK(7, 4)

#define SET_SDMMC_FIELD(val, field) (((val) << field##_SHIFT) & field##_MASK)
#define GET_SDMMC_FIELD(val, field) (((val) & field##_MASK) >> field##_SHIFT)
